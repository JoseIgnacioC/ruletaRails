...
class BetsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create bet" do
    assert_difference('Bet.count') do
      post bets_url, params: { bet: { amount: @bet.amount, player_id: @bet.player_id, round_id: @bet.round_id } }
    end
  ...
  test "should update bet" do
    patch bet_url(@bet), params: { bet: { amount: @bet.amount, player_id: @bet.player_id, round_id: @bet.round_id } }
